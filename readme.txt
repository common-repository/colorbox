...
Huge-It Popup Colorbox is the most inimitable plugin for WordPress users that can implement popup-effect look for the images/videos (when clicking on the thumbnails of the image/video they nicely open in the same window with a beautiful effect). The performance of Popup Colorbox is designed by our designers, who took the time and effort to make. Tool is highly distinctive because of two things:
...
An indispensable product that always satisfy you thanks to the variety of customizable options. The Popup Colorbox from Huge-IT is able to display beautiful images/videos and even your video links from YouTube and Vimeo.  Among wonderful potentials of Huge-It Popup Colorbox plugin you can find: 
...
* With this Popup Colorbox you can choose the attitude on your page, while it's opened, as well as the style of it’s acting.
...
Now you can set your options, images and use our plugin.

== Screenshots ==
    
1.  WordPress - Demo image
2.  WordPress - Demo video
...
* Style. Choose the best style
* Transition type. Select the way how acts.
* Opening speed. Here you can determine the speed of opening, select in milliseconds.
* Closing speed. Determine the speed of closing, select in milliseconds.
* Show the title. Choose it, if you need to show the title.
* Overlay transparency. Choose the level of background transparency.
...
* ESC close. This will close on pressing ESC button
...
* Show close button. Select this, to enable close button
* Popup size fix. Select to fix width and height
* Popup height. Set the height
* Popup width. Set the width
* Popup max width. If size is unfixed, set the maximal width for it 
* Popup max height. If size is unfixed, set the maximal height for it 
* Popup initial height. Set the starting height of opening process.
* Popup initial width. Set the starting width of opening process.
...
* Popup position. Set the place for popup on your page.
